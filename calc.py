...
CSV_FILE = "joints_coordinates_test.csv"       # Input joint coordinates file
OUTPUT_FILE = "ground_truth_distances.csv"     # Output distance file
...
def angle_at_point(A, B, C):
    ...
    try:
        ...
        if mag_BA == 0 or mag_BC == 0:
            return None
        cos_angle = max(-1, min(1, dot_product / (mag_BA * mag_BC)))  # Clamp for safety
